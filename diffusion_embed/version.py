...
.. _README: https://github.com/uwescience/diffusion_embed/blob/master/README.md

License
=======
``diffusion_embed`` is licensed under the terms of the MIT license. See the file
...
VERSION = __version__
PACKAGE_DATA = {'diffusion_embed': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
